						...
						<div class="panel-group" id="home-accordion" role="tablist" aria-multiselectable="true">
							...
							<div class="panel panel-default">
								<div class="panel-heading" role="tab" id="headingTwo">
									<h4 class="panel-title">
										<a class="collapsed" data-toggle="collapse" data-parent="#home-accordion"
									...
									<div class="item">
											...
											<div class="tr-add-cart">
												<ul>
													...
													<li><a class="fa fa-search tr_search"
															href="index.php?act=product-detail"></a></li>
												</ul>
											</div>
										</div>
										<div class="item-new">
										...
										<div class="item-sub">
											<a href="index.php?act=product-detail">
												<h5>casual fashion wool coat</h5>
											</a>
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="main_cat_item">
									<div class="item">
										...
										<div class="item-sub">
											<a href="index.php?act=product-detail">
												<h5>volv checked casual shirt</h5>
											</a>
											<p>$ 95.66</p>
										</div>
									</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="main_cat_item">
									<div class="item">
										...
										<div class="item-sub">
											<a href="index.php?act=product-detail">
												<h5>yellow Clover Robe Jacket</h5>
											</a>
											<p>$ 100.00</p>
										</div>
									</div>
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="main_cat_item">
									<div class="item">
										...
										<div class="item-sub">
											<a href="index.php?act=product-detail">
												<h5>super Clover Robe Jacket</h5>
											</a>
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="main_cat_item">
									<div class="item">
										...
										<div class="item-sub">
											<a href="index.php?act=product-detail">
												<h5>houndsmooth wool t-shirt</h5>
											</a>
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="main_cat_item">
									<div class="item">
										...
										<div class="item-sub">
											<a href="index.php?act=product-detail">
												<h5>structured collarless coat</h5>
											</a>
